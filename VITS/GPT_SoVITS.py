...
class GPT_SoVITS:
    ...
    def predict(self, ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut="不切",
    ...
    def get_tts_wav(self, ref_wav_path, prompt_text, prompt_language, text, text_language, how_to_cut="不切",
                    save_path='vits_res.wav'):
        t0 = ttime()
