    ...
    def predict(self,
        ...
        try:
            (
                gpt_cond_latent,
                speaker_embedding,
            ) = self.model.get_conditioning_latents(audio_path=speaker_wav, gpt_cond_len=30, gpt_cond_chunk_len=4,
                                                    max_ref_length=60)
...
def main():
    with gr.Blocks(analytics_enabled=False) as demo:
        ...
        tts_button.click(XTTS().predict, [input_text_gr, language_gr, ref_gr, clean_ref_gr],
                         outputs=[audio_gr, out_text_gr, ref_audio_gr])
    return demo
